...
import { ArrowDownTrayIcon, XCircleIcon, XMarkIcon } from "@heroicons/react/24/outline";
...
const Home: NextPage = ({ images }: { images: ImageProps[] }) => {
  ...
  return (
    <>
      ...
      <main className="mx-auto relative max-w-[1960px]">
  {photoId && (
    <Modal
      images={images}
      onClose={() => {
  ...
  <HeroComp text="Luxury Men Photography" />
...
export async function getStaticProps() {
  const results = await cloudinary.v2.search
    .expression(`folder:${process.env.NEXT_PUBLIC_CLOUDINARY_FOLDER_MALE}/*`)
